...
<html lang="zxx" class="js">
    <head>
        ...
        <!-- Page Title  -->
        <title>Internify | Portal Magang</title>
        <!-- StyleSheets  -->
                                                ...
                                                <div class="card card-bordered h-100">
                                                    <div class="card-inner">
                                                        <div class="card-title-group align-start gx-3 mb-3">
                                                            ...
                                                            <div class="card-tools">
                                                                <div class="dropdown">
                                                                    <a href="#" class="btn btn-primary btn-dim d-none d-sm-inline-flex" data-bs-toggle="dropdown">
                                                                    ...
                                                                    <a href="#" class="btn btn-icon btn-primary btn-dim d-sm-none" data-bs-toggle="dropdown">
                                                                        <em class="icon ni ni-download-cloud"></em>
                                                                    </a>
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                        ...
                                                        <li class="nk-support-item">
                                                            ...
                                                            <div class="nk-support-content">
                                                                <div class="title">
                                                                    ...
                                                                    <span class="badge badge-dot badge-dot-xs bg-info ms-1">Open</span>
                                                                </div>
                                                                <p>Thanks for contact us with your issues...</p>
                                                                <span class="time">2 Hours ago</span>
                                                            </div>
                                                        ...
                                                        <li class="nk-support-item">
                                                            ...
                                                            <div class="nk-support-content">
                                                                <div class="title">
                                                                    ...
                                                                    <span class="badge badge-dot badge-dot-xs bg-success ms-1">Solved</span>
                                                                </div>
                                                                <p>Thanks for contact us with your issues...</p>
