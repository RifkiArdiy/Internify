...
<html lang="zxx" class="js">
                            ...
                            <div class="header-wrap">
                                <div class="header-logo">
                                    <a href="html/index.html" class="logo-link">
                                        <img class="logo-light logo-img" src="{{asset('assets/home/images/logo.png')}}" srcset="{{asset('assets/home/images/logo2x.png 2x')}}" alt="logo">
                                        <img class="logo-dark logo-img" src="{{asset('assets/home/images/logo-dark.png')}}" srcset="{{asset('assets/home/images/logo-dark2x.png 2x')}}" alt="logo-dark">
                                    </a>
                                </div>
                                    ...
                                    <ul class="menu-list ms-lg-auto">
                                        {{-- <li class="menu-item has-sub">
                                            ...
                                            <div class="menu-sub">
                                                <ul class="menu-list">
                                                    <li class="menu-item">
                                                        <a href="html/index.html" class="menu-link">Landing Page - v1</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="html/index-v2.html" class="menu-link">Landing Page - v2</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="html/index-v3.html" class="menu-link">Landing Page - v3</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="html/index-v4.html" class="menu-link">Landing Page - v4</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="html/index-v5.html" class="menu-link">Landing Page - v5</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="html/index-v6.html" class="menu-link">Landing Page - v6</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                                ...
                                                <ul class="menu-list">
                                                    <li class="menu-item has-sub">
                                                        ...
                                                        <div class="menu-sub">
                                                            <ul class="menu-list">
                                                                <li class="menu-item">
                                                                    <a href="html/pages/auths/auth-login.html" class="menu-link" target="_blank">Login / Signin</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="html/pages/auths/auth-login-v2.html" class="menu-link" target="_blank">Login / Signin v2</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="html/pages/auths/auth-login-v3.html" class="menu-link" target="_blank">Login / Signin v3</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="html/pages/auths/auth-register.html" class="menu-link" target="_blank">Register / Signup</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="html/pages/auths/auth-register-v2.html" class="menu-link" target="_blank">Register / Signup v2</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="html/pages/auths/auth-register-v3.html" class="menu-link" target="_blank">Register / Signup v3</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="html/pages/auths/auth-reset.html" class="menu-link" target="_blank">Forgot Password</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="html/pages/auths/auth-reset-v2.html" class="menu-link" target="_blank">Forgot Password v2</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="html/pages/auths/auth-reset-v3.html" class="menu-link" target="_blank">Forgot Password v3</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                    <li class="menu-item has-sub">
                                                        ...
                                                        <div class="menu-sub">
                                                            <ul class="menu-list">
                                                                <li class="menu-item">
                                                                    <a href="html/pages/errors/404-classic.html" target="_blank" class="menu-link">404 Classic</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="html/pages/errors/404-modern.html" target="_blank" class="menu-link">404 Modern</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="html/pages/errors/504-classic.html" target="_blank" class="menu-link">504 Classic</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="html/pages/errors/504-modern.html" target="_blank" class="menu-link">504 Modern</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
	...
	c16.7,0,33.4-4.7,48.4-14l263.5-164.3c27-16.8,43.1-45.9,43.1-77.7S463.2,195.2,436.2,178.3z"/>
                                ...
                                <div class="col-lg-6 col-md-10">
                                    <div class="header-caption">
                                        ...
                                        <h1 class="header-title fw-medium">Build your website with Dashlite template</h1>
                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-xl-7 col-md-8">
                                <div class="section-head">
                                    <h2 class="title text-dark">With all the features you need</h2>
		...
		C231.2,268.8,234.9,272.5,239.5,272.5z"/>
                                            ...
                                            <div class="service-text">
                                                <h5 class="title text-dark">Powerful Admin</h5>
                        ...
                        <div class="row align-items-center g-gs">
                            <div class="col-lg-6">
                                <div class="img-block img-block-s2 pe-xl-6 pe-lg-3">
                                    <img src="{{asset('assets/home/images/gfx/g.png')}}" alt="">
                                </div>
                                <!-- .img-block -->
                            </div>
                            <!-- .col -->
	...
	c0,10.3-8.4,18.7-18.7,18.7C26.2,183,17.8,174.6,17.8,164.3z"/>
                                            ...
                                            <div class="col-12">
                                                <div class="card service service-inline service-s4 after-bg-primary">
                                                    <div class="card-inner">
                                                        <div class="service-icon styled-icon styled-icon-s4 styled-icon-5x text-primary">
                                                            <svg x="0px" y="0px" viewBox="0 0 512 512" style="fill:currentColor" xml:space="preserve">
	...
	l22.3,21.7c1.7,1.7,2.5,4.1,2.1,6.5l-5.3,30.7l27.5-14.5C253.4,228.9,254.5,228.6,255.7,228.6z"/>
			...
			c-11.9,0-21.6-9.7-21.6-21.6V417h102.2V434.4z"/>
                                                                ...
                                                                <g>
                                                                    <g>
                                                                        <path d="M256,0c-5.5,0-10,4.5-10,10v37.3c0,5.5,4.5,10,10,10c5.5,0,10-4.5,10-10V10C266,4.5,261.5,0,256,0z"/>
                                                                    </g>
                                                                </g>
                                                                <g>
                                                                    <g>
                                                                ...
                                                                <g>
                                                                    <g>
                                                                        <path d="M77.3,216H40c-5.5,0-10,4.5-10,10s4.5,10,10,10h37.3c5.5,0,10-4.5,10-10S82.8,216,77.3,216z"/>
                                                                    </g>
                                                                </g>
                                                                <g>
                                                                    <g>
                        ...
                        <div class="row flex-row-reverse align-items-center justify-content-between g-gs">
                            <div class="col-xl-6 col-lg-5">
                                <div class="img-block img-block-s2 ps-xl-6">
                                    <img src="{{asset('assets/home/images/gfx/h.png')}}" alt="img">
                                </div>
                                <!-- .img-block -->
                            </div>
                            <!-- .col -->
                            <div class="col-xl-6 col-lg-7">
                                <div class="text-block">
                                    <h2 class="title text-dark text-center text-lg-start">Instantly upload any software usage SaaS dashlite data</h2>
                                            ...
                                            <div class="card service service-s4 after-bg-pink">
                                                <div class="card-inner">
                                                    <div class="service-icon styled-icon styled-icon-4x text-pink">
                                                        <svg x="0px" y="0px" viewBox="0 0 515 512" style="fill:currentColor" xml:space="preserve">
                                                            <path d="M348.3,155.1c-5.5,0-10,4.5-10,10c0,5.5,4.5,10,10,10c5.5,0,10-4.5,10-10C358.3,159.6,353.9,155.1,348.3,155.1z"/>
                                                            <path d="M166.7,336.8c-5.5,0-10,4.5-10,10c0,5.5,4.5,10,10,10c5.5,0,10-4.5,10-10C176.7,341.3,172.2,336.8,166.7,336.8z"/>
	...
	L439.4,452z"/>
		...
		"/>
                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-lg-9 col-md-10">
                                <div class="text-block is-compact py-3">
                                    <h2 class="title">Best Selling SaaS Dashlite Template Set </h2>
                                    <p>Join 2,800 happy customers & start creating beautiful campaign today</p>
                                    <ul class="btns-inline justify-center pt-2">
                                        <li>
                                            <a href="#" class="btn btn-xl btn-primary btn-round">Buy Dashlite Today</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <!-- .section -->
                <section class="section pb-0" id="package">
                    <div class="container">
                        <div class="row justify-content-center text-tenter">
                            <div class="col-xl-7 col-lg-9">
                                <div class="section-head text-center mb-1">
                                    <h2 class="title text-dark mb-0">Best pricing package start business</h2>
                                    <p>Continually network virtual strategic theme areas vis-a-vis ubiquitous potentialities. Holisticly negotiate focused e-tailers without premium solutions..</p>
                                </div>
                            </div>
                            <!-- .col -->
                                            ...
                                            <div class="card-inner card-inner-xl">
                                                <div class="text-block">
                                                    ...
                                                    <ul class="list list-nostyle fs-15px mb-1">
                                                        ...
                                                        <li class="note text-warning fs-14px">+ All future update releases for Free</li>
                                                    </ul>
                                                    <ul class="btns-inline pt-4">
                                                        <li>
                                                            <a href="#" class="btn btn-round btn-xl btn-primary fs-16px">Purchase Now for $50</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-inner card-inner-lg">
                                                <div class="text-block is-compact pe-3">
                                                    ...
                                                    <ul class="btns-inline pt-2">
                                                        <li>
                                                            <a href="#" class="btn btn-lg btn-round btn-secondary">
                                                                <span>Purchase Now for $29</span>
                ...
                <section class="section section-team pb-0" id="team">
                    <div class="container">
                        <div class="row justify-content-center text-center">
                            <div class="col-xl-7 col-lg-9">
                                <div class="section-head">
                                    <h2 class="title text-dark px-1">Have questions or need support? Our team is here to help!</h2>
                                    <p>Continually network virtual strategic theme areas vis-a-vis ubiquitous potentialities. Holisticly negotiate focused e-tailers without premium solutions..</p>
                                </div>
                            </div>
                            <!-- .col -->
                        ...
                        <div class="row g-gs justify-content-center">
                            ...
                            <div class="col-lg-3 col-sm-6 col-mb-6">
                                <div class="team team-s1">
                                    <div class="team-portrait">
                                        <img src="{{asset('assets/home/images/team/b.jpg')}}" alt="">
                                    </div>
                                    <div class="team-info">
                            ...
                            <div class="col-lg-3 col-sm-6 col-mb-6">
                                <div class="team team-s1">
                                    <div class="team-portrait">
                                        <img src="{{asset('assets/home/images/team/c.jpg')}}" alt="">
                                    </div>
                                    <div class="team-info">
                            ...
                            <div class="col-lg-3 col-sm-6 col-mb-6">
                                <div class="team team-s1">
                                    <div class="team-portrait">
                                        <img src="{{asset('assets/home/images/team/d.jpg')}}" alt="">
                                    </div>
                                    <div class="team-info">
                        ...
                        <div class="row justify-content-lg-center text-lg-center">
                            <div class="col-lg-6 col-md-10">
                                <div class="section-head">
                                    ...
                                    <p class="fs-15px">Continually network virtual strategic theme areas vis-a-vis ubiquitous potentialities. Holisticly negotiate focused e-tailers without premium solutions.</p>
                                </div>
                            </div>
                            <!-- .col -->
                        </div>
                ...
                <footer class="footer bg-dark is-dark">
                    <div class="container">
                        <div class="row g-gs justify-content-between py-4 py-md-6">
                            <div class="col-lg-4 col-md-6">
                                <div class="widget widget-about mt-n2">
                                    <a href="html/index.html" class="logo-link">
                                        <img class="logo-light logo-img" src="{{asset('assets/home/images/logo.png')}}" srcset="{{asset('assets/home/images/logo2x.png 2x')}}" alt="logo">
                                        <img class="logo-dark logo-img" src="./images/logo-dark.png" srcset="{{asset('assets/home/images/logo-dark2x.png 2x')}}" alt="logo-dark">
                                    </a>
                        ...
                        <div class="row g-3 align-items-center justify-content-md-between py-4">
                            <div class="col-md-8">
                                <div>
                                    Copyright &copy;2023 Dashlite. Template Made by <a class="text-base fw-bold" href="#">Softnio</a>
                                </div>
                            </div>
                            <!-- .col -->
