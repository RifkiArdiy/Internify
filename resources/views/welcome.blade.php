...
<body class="nk-body bg-white npc-landing ">
                        ...
                        <div class="row flex-lg-row-reverse align-items-center justify-content-between g-gs">
                            <div class="col-lg-6 mb-lg-0">
                                <div class="header-play text-lg-center">
                                    <a class="play popup-video"
                                        href="{{ url('https://www.youtube.com/watch?v=SSo_EIwHSd4') }}">
 ...
 c16.7,0,33.4-4.7,48.4-14l263.5-164.3c27-16.8,43.1-45.9,43.1-77.7S463.2,195.2,436.2,178.3z" />
                    ...
                    <div class="row justify-content-center text-center">
                        <div class="col-xl-7 col-md-8">
                            <div class="section-head">
                                <h2 class="title text-dark">Semua yang Kamu Butuhkan untuk Kelola Magang</h2>
                                <p>Internify dirancang untuk menyederhanakan proses magang dari awal hingga akhir.
                                    Inilah fitur-fitur unggulan yang membuat Internify jadi pilihan tepat:
                                </p>
                            </div>
                            <!-- .section-head -->
                        </div>
                                                ...
                                                <g>
                                                    <g>
                                                        <path style="fill:currentColor"
                                                            d="M305.6,41l-15-29.9c-5-9.9-17.1-13.9-27-8.9L13.8,127.6c-9.9,5-13.9,17.1-8.9,27l41.3,82.3
   ...
   L461.9,492.6z" />
                                        ...
                                        <div class="service-text">
                                            <h5 class="title text-dark">Sistem Persetujuan Online</h5>
                                            <p>
                                                Permudah proses administrasi tanpa perlu dokumen fisik.
                                            </p>
                                        </div>
                                    </div>
                                </div>
  ...
  C231.2,268.8,234.9,272.5,239.5,272.5z" />
                                        ...
                                        <div class="service-text">
                                            <h5 class="title text-dark">Dashboard Terintegrasi</h5>
                                            <p>Kelola semua aktivitas magang dalam satu tampilan menarik.</p>
                                        </div>
                                    </div>
                                    <!-- .service -->
                                </div>
 ...
 C209.6,280.1,213,276.7,213,272.6z" />
                                                <path
                                                    d="M339.4,272.6v-11.4c0-4.1-3.4-7.5-7.5-7.5s-7.5,3.4-7.5,7.5v11.4c0,4.1,3.4,7.5,7.5,7.5S339.4,276.7,339.4,272.6z" />
 ...
 C369.9,213.2,370,213.3,370.1,213.4z" />
                                        ...
                                        <div class="service-text">
                                            <h5 class="title text-dark">Pencarian & Penempatan Magang</h5>
                                            <p>Temukan daftar instansi terverifikasi
                                    ...
                                    <div class="row gy-gs">
                                        <div class="col-12">
                                            <div class="card service service-inline service-s4 after-bg-danger">
                                                <div class="card-inner">
                                                    <div
                                                        class="service-icon styled-icon styled-icon-s4 styled-icon-5x text-danger">
 ...
 c0,10.3-8.4,18.7-18.7,18.7C26.2,183,17.8,174.6,17.8,164.3z" />
                                                    ...
                                                    <div class="service-text">
                                                        ...
                                                        <p>Many variations of passages of Lorem Ipsum available, but the
 ...
 l22.3,21.7c1.7,1.7,2.5,4.1,2.1,6.5l-5.3,30.7l27.5-14.5C253.4,228.9,254.5,228.6,255.7,228.6z" />
                                                    ...
                                                    <div class="service-text">
                                                        ...
                                                        <p>Slightly variations of passages available the majority have
                                                            suffered alteration even slightly believable.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- .card -->
                                        ...
                                        <div class="col-12">
                                            <div class="card service service-inline service-s4 after-bg-pink">
                                                <div class="card-inner">
                                                    <div
                                                        class="service-icon styled-icon styled-icon-s4 styled-icon-5x text-pink">
                                                        <svg x="0px" y="0px" viewBox="0 0 512 512"
                                                            style="fill:currentColor" xml:space="preserve">
                                                            <g>
                                                                <g>
                ...
                <div class="container">
                    <div class="row flex-row-reverse align-items-center justify-content-between g-gs">
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="text-block">
                                <h2 class="title text-dark text-center text-lg-start">Instantly upload any software
                                    usage SaaS dashlite data</h2>
                                        ...
                                        <div class="card service service-s4 after-bg-pink">
                                            <div class="card-inner">
                                                <div class="service-icon styled-icon styled-icon-4x text-pink">
                                                    <svg x="0px" y="0px" viewBox="0 0 515 512"
                                                        style="fill:currentColor" xml:space="preserve">
                                                        <path
                                        ...
                                        <div class="card-inner card-inner-xl">
                                            <div class="text-block">
                                                ...
                                                <ul class="list list-nostyle fs-15px mb-1">
                                                    ...
                                                    <li class="note text-warning fs-14px">+ All future update releases
                                                        for Free</li>
                                                </ul>
                                                <ul class="btns-inline pt-4">
                                                    <li>
                                                        <a href="#"
                                                            class="btn btn-round btn-xl btn-primary fs-16px">Purchase
                                                            Now for $50</a>
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="widget widget-about mt-n2">
                                <a href="html/index.html" class="logo-link">
                                    ...
                                    <img class="logo-dark logo-img"
                                        src="{{ asset('assets/home/images/logo-dark.png') }}"
                                        srcset="{{ asset('assets/home/images/logo-dark2x.png 2x') }}"
                                        alt="logo-dark">
                                </a>
