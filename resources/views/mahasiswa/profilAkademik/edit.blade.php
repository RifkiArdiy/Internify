...
@section('content')
    <div class="card card-bordered card-preview">
        <div class="card-inner">
            ...
            <form method="POST" action="{{ route('profil-akademik.update', $profilAkademik->profile_id) }}"
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-label" for="bidang_keahlian">Bidang Keahlian: <span
                                ...
                                <select class="form-control" id="bidang_keahlian" name="bidang_keahlian" required>
                                    ...
                                    @foreach ($kriteria as $requirement)
                                        <option value="{{ $requirement }}"
                                            {{ $profilAkademik->bidang_keahlian == $requirement ? 'selected' : '' }}>
                                            {{ $requirement }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-label" for="sertifikasi">Sertifikasi: <span
                                    class="text-danger">*</span></label>
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="sertifikasi" name="sertifikasi"
                                    value="{{ $profilAkademik->sertifikasi }}" placeholder="Masukkan sertifikasi anda"
                                    required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="lokasi" name="lokasi"
                                    value="{{ $profilAkademik->lokasi }}" placeholder="Masukkan lokasi anda" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-label" for="pengalaman">Pengalaman: <span
                                    class="text-danger">*</span></label>
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="pengalaman" name="pengalaman"
                                    value="{{ $profilAkademik->pengalaman }}" placeholder="Masukkan pengalaman anda"
                                    required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="etika" name="etika"
                                    value="{{ $profilAkademik->etika }}" placeholder="Masukkan etika anda" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="ipk" name="ipk"
                                    value="{{ $profilAkademik->ipk }}" placeholder="Masukkan Nilai IPK" required>
                            </div>
                        </div>
                    </div>
