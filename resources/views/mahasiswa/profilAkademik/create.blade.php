                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="sertifikasi" name="sertifikasi"
                                    value="{{ old('sertifikasi') }}" placeholder="Masukkan sertifikasi anda" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="lokasi" name="lokasi"
                                    value="{{ old('lokasi') }}" placeholder="Masukkan lokasi anda" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="pengalaman" name="pengalaman"
                                    value="{{ old('pengalaman') }}" placeholder="Masukkan pengalaman anda" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="etika" name="etika"
                                    value="{{ old('etika') }}" placeholder="Masukkan etika anda" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="ipk" name="ipk"
                                    value="{{ old('ipk') }}" placeholder="Masukkan Nilai IPK" required>
                            </div>
                        </div>
                    </div>
