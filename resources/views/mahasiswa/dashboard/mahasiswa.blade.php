                        ...
                        <div class="project">
                            ...
                            <div class="project-progress">
                                <div class="project-progress-details">
                                    <div class="project-progress-task"><em class="icon ni ni-check-round-cut"></em><span>3
                                            Tasks</span></div>
                            ...
                            <div class="project-meta">
                                <ul class="project-users g-1">
                                    ...
                                    <li>
                                        <div class="user-avatar sm bg-blue"><img src="./images/avatar/b-sm.jpg"
                                                alt=""></div>
                                    </li>
                                    <li>
                    ...
                    <div class="card-inner">
                        <div class="project">
                            ...
                            @else
                                ...
                                <div class="text-end">
                                    <a href="{{ route('list.lowongan') }}" class="btn btn-sm btn-primary">Cari Lowongan</a>
                                </div>
                            @endif
                        </div>
                    </div>
                                ...
                                <div class="drodown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <ul class="link-list-opt no-bdr">
                                            ...
                                            <li><a href="#"><em class="icon ni ni-edit"></em><span>Edit
                                                        Project</span></a></li>
                                            <li><a href="#"><em class="icon ni ni-check-round-cut"></em><span>Mark
                                                        As
                                                        Done</span></a></li>
                                        </ul>
                                    </div>
                    ...
                    <div class="card-inner">
                        <div class="project">
                            ...
                            <div class="project-meta">
                                <ul class="project-users g-1">
                                    <li>
                                        <div class="user-avatar sm bg-primary"><img src="./images/avatar/c-sm.jpg"
                                                alt=""></div>
                                    </li>
                                    <li>
                                ...
                                <span class="badge badge-dim bg-light text-gray"><em
                                        class="icon ni ni-clock"></em><span>21
                                        Days Left</span></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-bordered h-100">
                    <div class="card-inner">
                        <div class="project">
                            <div class="project-head">
                                <a href="html/apps-kanban.html" class="project-title">
                                    <div class="user-avatar sq bg-info"> <em class="ni ni-file-check-fill"></em></div>
                                    <div class="project-info">
                            ...
                            <div class="project-progress">
                                <div class="project-progress-details">
                                    <div class="project-progress-task"><em class="icon ni ni-check-round-cut"></em><span>2
                                            Tasks</span></div>
                            ...
                            <div class="project-meta">
                                <ul class="project-users g-1">
                                    <li>
                                        <div class="user-avatar sm bg-primary"><img src="./images/avatar/a-sm.jpg"
                                                alt=""></div>
                                    </li>
                                </ul>
